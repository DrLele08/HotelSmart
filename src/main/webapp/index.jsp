    ...
    <div id="carouselHome" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="http://localhost:8080/HotelSmart_war_exploded/images/hotelroom6.jpg" alt="First slide">
                <div class="carousel-caption d-none d-md-block">
                    <h2>Le migliori stanze per tutte le necessità</h2>
                </div>
            </div>
            <div class="carousel-item">
                <img src="http://localhost:8080/HotelSmart_war_exploded/images/hotelroom7.jpg" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                    <h2>Scegli HotelSmart per un servizio di qualità</h2>
                </div>
            </div>
            <div class="carousel-item">
                <img src="http://localhost:8080/HotelSmart_war_exploded/images/hotelroom9.jpg" alt="Third slide">
                <div class="carousel-caption d-none d-md-block">
                    <h2>Diocane</h2>
                </div>
            </div>
